<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center">
		<h2 class="font-bold">Twitch Raffle Logger</h2>
		<p>
			Shows your <a href="https://github.com/ErcouldnT/twitch-raffle-bot">twitch-raffle-bot</a> results.
		</p>
		<!-- Animated Logo -->
		<figure>
		...
		<div class="flex justify-center space-x-2">
			<a class="btn btn-filled" href="/dashboard">Go to your dashboard</a>
		</div>
		<div class="space-y-2 flex flex-col">
			<p>Source code:</p>
			<a href="https://github.com/ErcouldnT/twitch-raffle-log"><code>twitch-raffle-log</code></a>
			<a href="https://erkut.dev"><code>https://erkut.dev</code></a>
			<div class="text-xs font-light">© 2023</div>
		</div>
	</div>
</div>
